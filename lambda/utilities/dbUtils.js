...
(function (DbUtils) {
    ...
    async function getData(tableName) {
        ...
        if (getPromise.$response.error) {
            ...
            customLogger_1.CustomLogger.log("Data retrieved from DynamoDB: " + JSON.stringify(getPromise.Item));
    ...
    async function setData(tableName, data) {
        ...
        if (putPromise.$response.error) {
            ...
            customLogger_1.CustomLogger.log("Data saved to DynamoDB: " + JSON.stringify(data));
            return true;
        }
    }
